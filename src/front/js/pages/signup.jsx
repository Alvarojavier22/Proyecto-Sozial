...
export const SignUp = () => {
  ...
  const passwordCheck = (pass) => {
    if (pass.length < 8) {
      ...
      !new RegExp(/^(?=.*[A-Za-z])(?=.*\d)[A-Za-z\d]{8,}$/).test(pass)
    ) {
      return swal({
        title: "Oops!",
        ...
        <div className="signup-content">
          <form className="signup" onSubmit={handleSubmit}>
            ...
            <div className="signup_field">
              ...
              />
              <i
                className={`far fa-eye${passHide == true ? "" : "-slash"} `}
                onClick={() =>
              ...
              ></i>
              <input
                onClick={() => passwordCheck(password)}
                type={`${confirmPassHide == true ? "password" : "text"}`}
                value={confirmpass || ""}
              ...
              <i
                className={`far fa-eye${
                  confirmPassHide == true ? "" : "-slash"
                } `}
                onClick={() =>
                  confirmPassHide == true
                    ? setConfirmPassHide(false)
                    : setConfirmPassHide(true)
                }
                id="togglePassword"
                style={{ marginLeft: "-30px", cursor: "pointer" }}
              ></i>
            ...
            <div className="form-check" id="check">
              ...
              <label className="form-check-label" htmlFor="flexCheckDefault">
                I accept the{" "}
                <label className="form-check-label" htmlFor="flexCheckDefault">
                  <Link to="/termsandconditions" id="linksign">
                    terms of use
                  </Link>{" "}
                  &{" "}
                  <Link to="/termsandconditions" id="linksign">
