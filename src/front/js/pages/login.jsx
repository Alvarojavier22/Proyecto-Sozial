	...
	<div className="screen">
		<div className="screen__content">
            ...
            <div className="login__field">
              <i className="login__icon fas fa-lock"></i>
              <input
                type={`${loginPassHide == true ? "password" : "text"}`}
              ...
              <i
                className={`far fa-eye${
                  loginPassHide == true ? "" : "-slash"
                } `}
                onClick={() =>
                  loginPassHide == true
                    ? setLoginPassHide(false)
                    : setLoginPassHide(true)
                }
                id="togglePassword"
                style={{ marginLeft: "-30px", cursor: "pointer" }}
              ></i>
            </div>
            <Link to="/feed" id="linklogin">
              <button
