    ...
    <div className="container-fluid">
       <nav className="navbar navbar-light bg-light">
        ...
        <div className="d-flex">
          <span className="navbar-brand">Sozial</span>
            ...
            <form className="d-none d-md-flex" style={{ marginLeft: "20px", width: "400px" }}>
              <input
            ...
            <button className="navbar-toggler d-md-none ms-auto " type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
